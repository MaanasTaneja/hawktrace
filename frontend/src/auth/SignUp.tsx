  ...
  return (
    <AuthLayout onBack={onBack}>
      <div className="text-center mb-10">
        ...
        <h2 className="font-serif text-2xl text-ink mb-3">Start catching bugs.</h2>
        <p className="font-sans text-mid text-[15px]">No QA background needed. No credit card required.</p>
      </div>

      <form className="space-y-5" onSubmit={handleSubmit}>
        <div className="space-y-1.5">
          <label className="block text-[11px] font-medium text-mid uppercase tracking-wider ml-1">Username</label>
          <input
            type="text"
            placeholder="janedoe"
            value={username}
        ...
        <div className="space-y-1.5">
          <label className="block text-[11px] font-medium text-mid uppercase tracking-wider ml-1">Company</label>
          <input
            type="text"
        ...
        <div className="space-y-1.5">
          <label className="block text-[11px] font-medium text-mid uppercase tracking-wider ml-1">Work email</label>
          <input
            type="email"
        ...
        <div className="space-y-1.5">
          <label className="block text-[11px] font-medium text-mid uppercase tracking-wider ml-1">Password</label>
          <input
            type="password"
            placeholder="••••••••"
            value={password}
