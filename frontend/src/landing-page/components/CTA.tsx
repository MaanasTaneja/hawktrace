...
export function CTA({ onGetStarted }: CTAProps) {
  return (
    <section className="relative py-36 px-8 bg-sand/80">
      {/* Top separator */}
      ...
      <div className="max-w-3xl mx-auto text-center">
        ...
        <motion.h2
          ...
          className="font-serif text-[clamp(2.4rem,5vw,4rem)] leading-[1.08] tracking-[-0.025em] text-ink mb-12"
        >
          Stop finding bugs
          <br />
          from your users.
          <br />
          <span className="italic text-mid font-mono text-[25px]">Start catching them first.</span>
        </motion.h2>
